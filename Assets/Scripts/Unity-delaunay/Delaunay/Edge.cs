...
namespace Delaunay
{
    ...
    public sealed class Edge
    {
        ...
        static public bool isSameEdge(Edge e1, Edge e2)
        {
            //Debug.Log(e1.a + " " + e1.b + " " + e1.c + " " + e2.a + " " + e2.b + " " + e2.c);
            float dif = Math.Abs(e1.a - e2.a) + Math.Abs(e1.b - e2.b) + Math.Abs(e1.c - e2.c);
            return dif < 1e-5;
        }
    }
}
